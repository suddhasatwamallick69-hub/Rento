<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo e(route('admin_dashboard')); ?>" class="logo d-flex align-items-center">
  ...
  </header><?php /**PATH C:\xampp\htdocs\laravel_auth\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>