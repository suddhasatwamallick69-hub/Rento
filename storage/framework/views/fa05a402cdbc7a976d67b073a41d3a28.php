        ...
        <div class="row content-row">
          ...
          <div class="col align-items-center flex-col">
            <div class="text sign-in">
              <h2 style="margin-right: 7.685rem;">
                Welcome to <a href="<?php echo e(route('index')); ?>">RENTO</a>
              </h2>
            </div>
            <div class="img sign-in" id="sign-in-img">
              <img src="<?php echo e(asset('assets/img/Rento6.png')); ?>" >
            </div>
          </div>
          <!-- END SIGN IN CONTENT -->
          <!-- SIGN UP CONTENT -->
          <div class="col align-items-center flex-col">
            <div class="img sign-up" id="sign-up-img">
              <img src="<?php echo e(asset('assets/img/Rento_car4.png')); ?>" alt="">
            </div>
            <div class="text sign-up">
              <h2 style="margin-left: 7.680rem;">
                Join with us at <a href="<?php echo e(route('index')); ?>">RENTO</a>
              </h2>
            </div>
          </div>
          <!-- END SIGN UP CONTENT -->
...
<?php /**PATH C:\xampp\htdocs\laravel_auth\resources\views/login_register.blade.php ENDPATH**/ ?>